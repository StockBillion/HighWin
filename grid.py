...
class GridTrade(utils.TradeTest):
    '双级海龟交易'
    ...
    def long_turtle(self, code, data_list):
        ...
        _opens, _highs, _lows, _closes = _data_vec[1], _data_vec[2], _data_vec[3], _data_vec[4]

        wavema = index.MovingAverage(_highs - _lows)
        Nl = wavema.moving_average(self.turtle_args[2])
        index.MovingAverage((_highs + _lows)/2)
